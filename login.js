...
function Login(){
  return(
    ...
    <input type="text" class="inputField" id="username" placeholder="Username"></input>
    </div>
...
<Link to ="/home"><button id="button">Submit</button></Link>
<Link to={"/register"}><div className="x">Don't hava an Account? SignUp</div></Link>
</form>
